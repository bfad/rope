...
EXE_DST = $(PWD) #$(LASSO9_HOME)/LassoExecutables
...
%.a.i386.$(INTERMEDIATE_EXT): %.lasso
	"$(LASSO9_MODULE_CMD)" $(MODULE_APP_FLAGS) -arch i386 -o $@ $<
%.d.x86_64.$(INTERMEDIATE_EXT): %.lasso
...
%.a.x86_64.$(INTERMEDIATE_EXT): %.lasso
